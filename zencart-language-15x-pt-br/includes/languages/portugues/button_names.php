...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Cadastrar-se');
define('BUTTON_LOG_OFF_ALT', 'Sair');
define('BUTTON_ADD_TO_CART_ALT', 'Adicionar ao meu carrinho de compras');
define('BUTTON_ADD_ADDRESS_ALT', 'Adicionar endere&ccedil;o');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Adicionar o produto selecionado ao carrinho');
define('BUTTON_BACK_ALT', 'Voltar');
define('BUTTON_BUY_NOW_ALT', 'Comprar agora');
define('BUTTON_CANCEL_ALT', 'Cancelar');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Alterar endere&ccedil;o');
define('BUTTON_CHECKOUT_ALT', 'Finalizar compra');
define('BUTTON_CONFIRM_SEND_ALT', 'Enviar vale-presente');
...
define('BUTTON_DELETE_ALT', 'Apagar');
define('BUTTON_DELETE_SMALL_ALT', 'Apagar');
define('BUTTON_DOWNLOAD_ALT', 'Fazer Download');
define('BUTTON_EDIT_SMALL_ALT', 'Editar');
define('BUTTON_IN_CART_ALT', 'Adicionar ao carrinho');
define('BUTTON_LOGIN_ALT', 'Entrar');
define('BUTTON_NEXT_ALT', 'Pr&oacute;ximo');
define('BUTTON_PREVIOUS_ALT', 'Anterior');
define('BUTTON_REDEEM_ALT', 'Ativar');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Retornar a lista de produtos');
define('BUTTON_REVIEWS_ALT', 'Ir para a p&aacute;gina de coment&aacute;rios');
define('BUTTON_SEARCH_ALT', 'Procurar');
define('BUTTON_SEND_ALT', 'Enviar agora');
define('BUTTON_SEND_ANOTHER_ALT', 'Enviar outro vale-presente');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Enviar um vale-presente');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Calcular frete');
define('BUTTON_SOLD_OUT_ALT', 'Esgotado');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Egotado');
define('BUTTON_SUBMIT_ALT', 'Continuar');
define('BUTTON_TELL_A_FRIEND_ALT', 'Diga a um amigo');
define('BUTTON_TELLAFRIEND_ALT', 'Diga a um amigo');
define('BUTTON_UNSUBSCRIBE', 'N&atilde;o receber Newsletter');
define('BUTTON_UPDATE_ALT', 'Atualizar');
define('BUTTON_VIEW_SMALL_ALT', 'Ver');
define('BUTTON_WRITE_REVIEW_ALT', 'Escrever coment&aacute;rio');
define('BUTTON_READ_REVIEWS_ALT', 'Ler coment&aacute;rio');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Ir para informa&ccedil;&otilde;es detalhadas deste produto');
define('BUTTON_MORE_REVIEWS_ALT', 'Ver mais coment&aacute;rios');
?>