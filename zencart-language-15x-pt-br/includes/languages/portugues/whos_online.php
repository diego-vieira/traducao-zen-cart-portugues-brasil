...
//
define('BOX_HEADING_WHOS_ONLINE', 'Quem est&aacute; online?');
define('BOX_WHOS_ONLINE_THEREIS', 'Atualmente h&aacute;');
define('BOX_WHOS_ONLINE_THEREARE', 'Existem atualmente');
