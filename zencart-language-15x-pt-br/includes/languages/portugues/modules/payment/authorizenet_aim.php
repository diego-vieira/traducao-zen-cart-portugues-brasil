...
// Catalog Items
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_CATALOG_TITLE', 'Cart&atilde;o de Cr&eacute;dito'); // Payment option title as displayed to the customer
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_CREDIT_CARD_TYPE', 'Tipo do Cart&atilde;o de Cr&eacute;dito:');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_CREDIT_CARD_OWNER', 'Propriet&aacute;rio do Cart&atilde;o de Cr&eacute;dito:');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_CREDIT_CARD_NUMBER', 'N&uacute;mero do Cart&atilde;o de Cr&eacute;dito:');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_CREDIT_CARD_EXPIRES', 'Data de validade do Cart&atilde;o:');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_CVV', 'CVV:');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_POPUP_CVV_LINK', 'O que &eacute; isto?');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_JS_CC_OWNER', '* O nome do propriet&aacute;rio do cart&atilde;o de cr&eacute;dito deve ter no m&iacute;nimo ' . CC_OWNER_MIN_LENGTH . ' caracteres.\n');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_JS_CC_NUMBER', '* O n&uacute;mero do cart&atilde;o de cr&eacute;dito deve conter no m&iacute;nimo ' . CC_NUMBER_MIN_LENGTH . ' caracteres.\n');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_JS_CC_CVV', '* O CVV de 3 ou 4 digitos pode ser encontrado atr&aacute; do seu cart&atilde;o.\n');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_DECLINED_MESSAGE', 'Seu Cart&atilde;o de Cr&eacute;dito pode n&atilde;o estar autorizado por esta raz&atilde;o. Por favor corrija alguma informa&ccedil;&atilde;o e tente denovo, ou entre em contato conosco para alguma assist&ecirc;ncia.');
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_ERROR', 'Erro no Cart&atilde;o de Cr&eacute;dito!');
