...
define('HEADING_TITLE_1', 'Pesquisa Avan&ccedil;ada');
define('HEADING_TITLE_2', 'Produtos Encontrados');
...
define('ENTRY_PRICE_RANGE', 'Procura por Pre&ccedil;os');
define('ENTRY_PRICE_FROM', 'Pre&ccedil;o M&iacute;nimo:');
define('ENTRY_PRICE_TO', 'Pre&ccedil;o M&aacute;ximo:');
define('ENTRY_DATE_RANGE', 'Procurar por Data');
define('ENTRY_DATE_FROM', 'Desde:');
define('ENTRY_DATE_TO', 'At&eacute;:');

define('TEXT_SEARCH_HELP_LINK', 'Ajuda para Procura [?]');
...
define('KEYWORD_FORMAT_STRING', 'Palavra-chave');
...
define('ERROR_PRICE_FROM_MUST_BE_NUM', 'Pre&ccedil;o m&iacute;nimo deve ser um n&uacute;mero.');
define('ERROR_PRICE_TO_MUST_BE_NUM', 'Pre&ccedil;o m&aacute;ximo deve ser um n&uacute;mero.');
define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', 'O pre&ccedil;o final deve ser maior ou igual ao pre&ccedil;o inicial.');
define('ERROR_INVALID_KEYWORDS', 'Palavras-chave Inv&aacute;lidas.');
