...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Remover avisos sobre este produto.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Me avise sobre atualiza&ccedil;&otilde;es deste produto.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Escrever um coment&aacute;rio sobre este produto.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Chamar pelo pre&ccedil;o atual.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Fora do ar para manuten&ccedil;&atilde;o. Tente novamente dentro de alguns minutos.');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'A APROVA&Ccedil;&Atilde;O DO CLIENTE EST&Aacute; PENDENTE ...');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', '5 Estrelas');
define('OTHER_REVIEWS_RATING_STARS_FOUR_ALT', '4 Estrelas');
define('OTHER_REVIEWS_RATING_STARS_THREE_ALT', '3 Estrelas');
define('OTHER_REVIEWS_RATING_STARS_TWO_ALT', '2 Estrelas');
define('OTHER_REVIEWS_RATING_STARS_ONE_ALT', '1 Estrela');
