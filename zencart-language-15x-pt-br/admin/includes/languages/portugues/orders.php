...
define('HEADING_TITLE_SEARCH_DETAIL_ORDERS_PRODUCTS', 'Search by Produto Name or <strong>ID:XX</strong> or Modelo ');
...
define('ENTRY_CREDIT_CARD_EXPIRES', 'Credit Card Expira:');
...
define('TEXT_INFO_HEADING_DELETE_ORDER', 'Excluir Order');
define('TEXT_INFO_DELETE_INTRO', 'Tem certeza que deseja excluir this order?');
define('TEXT_INFO_RESTOCK_PRODUCT_QUANTITY', 'Restock product quantity');
define('TEXT_DATE_ORDER_CREATED', 'Date Created:');
define('TEXT_DATE_ORDER_LAST_MODIFIED', 'Modificado em:');
...
define('EMAIL_TEXT_SUBJECT', 'Order Atualizar');
...
define('EMAIL_TEXT_STATUS_LABEL', '<strong>Novo status:</strong> %s' . "\n\n");
define('EMAIL_TEXT_STATUS_PLEASE_REPLY', 'Please reply to this email if you have any questions.' . "\n");

define('ERROR_ORDER_DOES_NOT_EXIST', 'Erro: Order does not exist.');
define('SUCCESS_ORDER_UPDATED', 'Success: Order has been successfully updated.');
define('WARNING_ORDER_NOT_UPDATED', 'Aten&ccedil;&atilde;o: Nothing to change. The order was not updated.');

define('ENTRY_ORDER_ID','Invoice No. ');
define('TEXT_INFO_ATTRIBUTE_FREE', '&nbsp;-&nbsp;<span class="alert">FREE</span>');

define('TEXT_DOWNLOAD_TITLE', 'Order Download Estado');
...
define('IMAGE_ICON_STATUS_CURRENT', 'Estado - Available');
define('IMAGE_ICON_STATUS_EXPIRED', 'Estado - Expired');
define('IMAGE_ICON_STATUS_MISSING', 'Estado - Missing');
