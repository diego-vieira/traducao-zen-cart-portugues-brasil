...
define('TEXT_PAGES_STATUS_CHANGE', 'Estado Change: %s');
define('TEXT_INFO_DELETE_INTRO', 'Tem certeza que deseja excluir this page?');
...
define('ERROR_PAGE_TITLE_REQUIRED', 'Erro: Page title required.');
define('ERROR_UNKNOWN_STATUS_FLAG', 'Erro: Unknown status flag.');
define('ERROR_MULTIPLE_HTML_URL', 'Erro: you have defined multiple settings when only one may be defined per Link ...<br />Only define either: HTML Content -or- Internal Link URL -or- External Link URL');
...
define('TEXT_WARNING_MULTIPLE_SETTINGS', '<strong>ATEN&Ccedil;&Atilde;O: Multiple Link Definition</strong>');
?>
