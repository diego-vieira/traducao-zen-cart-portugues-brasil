...
define('HEADING_TITLE_OPT', 'Produto Options');
define('HEADING_TITLE_VAL', 'Option Values');
define('HEADING_TITLE_ATRIB', 'Produtos Attributes');
...
define('TEXT_WARNING_OF_DELETE', '<span class="alert">This option has products and values linked to it - it is not safe to delete it.<br />NOTA: Any associated Download files for this Option Value will not be removed from the server.</span>');
...
define('TABLE_TEXT_MAX_COUNT_SHORT', 'Max:');
 ...
 define('TEXT_ATTRIBUTE_IS_DISCOUNTED', 'Apply Same Discounts<br />Used by Produto:');
 define('TEXT_ATTRIBUTE_PRICE_BASE_INCLUDED','Include in Base Price<br />When Priced by Attributes');

 define('TEXT_PRODUCT_OPTIONS_INFO','Edit Produto Options for additional settings');

// Option Names/Values copier from one to another
 define('TEXT_OPTION_VALUE_COPY_ALL', '<strong>Copy to ALL Produtos where Option Name and Value ...</strong>');
 ...
 define('TEXT_SELECT_OPTION_VALUES_TO_CATEGORIES_ID', 'Leave blank for ALL Produtos or<br />enter a Categoria ID for Produtos to update');
...
// Option Name/Value to Option Name for Category with Product defaults
 ...
 define('TEXT_INFO_OPTION_VALUE_COPY_OPTIONS_TO', 'Select an Option Name and Value that currently exists on a product or products to add to all products or to only the products in the selected category that have the selected Option Name.
                          <br /><strong>Example:</strong> Add Option Name: Color Option Value: Red to all Produtos with Option Name: Size
                          <br /><strong>Example:</strong> Add Option Name: Color Option Value: Green with default values from Produtos ID: 34 to all Produtos with Option Name: Size
                          <br /><strong>Example:</strong> Add Option Name: Color Option Value: Green with default values from Produtos ID: 34 to all Produtos with Option Name: Size for Categorias ID: 65
    ');
 ...
 define('TEXT_SELECT_OPTION_FROM_PRODUCTS_ID', 'Default Novo Attribute Values from Produto ID# or leave blank for no default values:');
 ...
 define('TEXT_COPY_ATTRIBUTES_UPDATE','<strong>Atualizar</strong> existing attributes with new settings/prices');
 ...
 define('ERROR_OPTION_VALUES_COPIED', 'Erro: Duplicate Option Name and Option Value');
 define('ERROR_OPTION_VALUES_COPIED_MISMATCH', 'Erro: Mismatched Option Name and Option Value selected');
 define('ERROR_OPTION_VALUES_NONE', 'Erro: Nothing found to copy');
 define('SUCCESS_OPTION_VALUES_COPIED', 'Successful copy! ');
 define('ERROR_OPTION_VALUES_COPIED_MISMATCH_PRODUCTS_ID', 'Erro: Missing Option Name/Value for Produtos ID#');

 define('TEXT_OPTION_VALUE_DELETE_ALL', '<strong>Delete Matching Attribute from ALL Produtos where Option Name and Value ...</strong>');
 define('TEXT_INFO_OPTION_VALUE_DELETE_ALL', 'Select an Option Name and Value that currently exists on a product or products that you want deleted from ALL Produtos or from ALL Produtos within one Categoria');
 ...
 define('ERROR_OPTION_VALUES_DELETE_MISMATCH', 'Erro: Mismatched Option Name and Option Value selected');
