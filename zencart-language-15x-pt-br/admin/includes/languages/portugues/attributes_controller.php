...
define('HEADING_TITLE_OPT', 'Op&ccedil;&otilde;es de Produtos');
define('HEADING_TITLE_VAL', 'Valores das Op&ccedil;&otilde;es');
define('HEADING_TITLE_ATRIB', 'Controlador de Atributos');
define('HEADING_TITLE_ATRIB_SELECT','Por favor, selecione uma Categoria para mostrar os atributos dos Produtos...');

define('TEXT_PRICES_AND_WEIGHTS', 'Pre&ccedil;os e Pesos');
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR', 'Fator de Pre&ccedil;o: ');
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET', 'Diferen&ccedil;a: ');
define('TABLE_HEADING_ATTRIBUTES_PRICE_ONETIME', 'Uma Vez:');

define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_ONETIME', 'Fator de Uma Vez: ');
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET_ONETIME', 'Diferen&ccedil;a: ');
...
define('TEXT_DOWNLOADS_DISABLED','NOTA: Downloads are disabled');
...
define('TABLE_TEXT_MAX_COUNT_SHORT', 'Max:');
 ...
 define('TEXT_ATTRIBUTES_IS_FREE', 'Attribute is Free<br />When Produto is Free:');
 define('TEXT_ATTRIBUTES_DEFAULT', 'Default Attribute<br />to be Marked Selected:');
 define('TEXT_ATTRIBUTE_IS_DISCOUNTED', 'Apply Discounts Used<br />by Produto Special/Sale:');
 ...
 define('LEGEND_KEYS','DESLIGADO/LIGADO');
 ...
 define('TEXT_PRODUCTS_LISTING','Produtos Listing for: ');
 define('TEXT_NO_PRODUCTS_SELECTED','No Produto Selected');
 define('TEXT_NO_ATTRIBUTES_DEFINED','No Attributes Defined for Produto ID#');

 define('TEXT_PRODUCTS_ID','Produtos ID#');
 define('TEXT_ATTRIBUTES_DELETE','DELETE ALL');
 define('TEXT_ATTRIBUTES_COPY_PRODUCTS','Copy to Produto');
 define('TEXT_ATTRIBUTES_COPY_CATEGORY','Copy to Categoria');
 ...
 define('TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_PRODUCT','Copy Attributes to another <strong>Produto</strong> from ID#');
 define('TEXT_INFO_ATTRIBUTES_FEATURE_COPY_TO','Select the Produto to copy all attributes to:');

 define('TEXT_ATTRIBUTES_COPY_TO_CATEGORY','CATEGORY');
 define('TEXT_INFO_ATTRIBUTES_FEATURE_CATEGORIES_COPY_TO','Select the Categoria to copy all attributes to:');
 define('TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_CATEGORY','Copy Attributes to all Produtos in <strong>Categoria</strong> from Produto ID#');
 ...
 define('SUCCESS_PRODUCT_UPDATE_SORT','Successful Attribute Sort Order Atualizar for ID# ');
 define('SUCCESS_PRODUCT_UPDATE_SORT_NONE','No Attributes to Atualizar Sort Order for ID# ');
 ...
 define('WARNING_PRODUCT_COPY_TO_CATEGORY_NONE','No Categoria selected for copy');
 define('TEXT_PRODUCT_IN_CATEGORY_NAME',' - in Categoria: ');

 define('TEXT_DELETE_ALL_ATTRIBUTES','Tem certeza que deseja excluir all attributes for ID# ');
...
// preview
 ...
 define('TEXT_PRODUCTS_PRICE', 'Produtos Price: ');
 define('TEXT_SPECIAL_PRICE', 'Pre&ccedil;o Especial: ');
 ...
 define('TEXT_DELETE_ATTRIBUTES_OPTION_NAME_VALUES', 'Confirm deletion of ALL of the Produto Option Values for Option Name ...');
 define('TEXT_INFO_PRODUCT_NAME', '<strong>Produto Name: </strong>');
