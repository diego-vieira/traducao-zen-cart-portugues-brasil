...
define('TABLE_HEADING_BANNER_OPEN_NEW_WINDOWS','Novo Window');
...
define('TEXT_BANNERS_HTML_TEXT_INFO', '<strong>NOTA: HTML banners do not record the clicks on the banner</strong>');
define('TEXT_BANNERS_HTML_TEXT', 'HTML Text:');
define('TEXT_BANNERS_ALL_SORT_ORDER', 'Sort Order - banner_box_all');
define('TEXT_BANNERS_ALL_SORT_ORDER_INFO', '<strong>NOTA: The banners_box_all sidebox will display the banners in their defined sort order</strong>');
define('TEXT_BANNERS_EXPIRES_ON', 'Expira On:');
...
define('TEXT_BANNERS_STATUS', 'Banner Estado:');
define('TEXT_BANNERS_ACTIVE', 'Active');
define('TEXT_BANNERS_NOT_ACTIVE', 'Not Active');
define('TEXT_INFO_BANNER_STATUS', '<strong>NOTA:</strong> Banner status will be updated based on Scheduled Date and Impressions');
define('TEXT_BANNERS_OPEN_NEW_WINDOWS', 'Banner Novo Window');
define('TEXT_INFO_BANNER_OPEN_NEW_WINDOWS', '<strong>NOTA:</strong> Banner will open in a new window');
define('TEXT_BANNERS_ON_SSL', 'Banner on SSL');
define('TEXT_INFO_BANNER_ON_SSL', '<strong>NOTA:</strong> Banner can be displayed on Secure Pages without errors');

define('TEXT_BANNERS_DATE_ADDED', 'Adicionado em:');
define('TEXT_BANNERS_SCHEDULED_AT_DATE', 'Scheduled At: <b>%s</b>');
define('TEXT_BANNERS_EXPIRES_AT_DATE', 'Expira At: <b>%s</b>');
define('TEXT_BANNERS_EXPIRES_AT_IMPRESSIONS', 'Expira At: <b>%s</b> impressions');
define('TEXT_BANNERS_STATUS_CHANGE', 'Estado Change: %s');
...
define('TEXT_INFO_DELETE_INTRO', 'Tem certeza que deseja excluir this banner?');
define('TEXT_INFO_DELETE_IMAGE', 'Excluir banner image');
...
define('ERROR_BANNER_TITLE_REQUIRED', 'Erro: Banner title required.');
define('ERROR_BANNER_GROUP_REQUIRED', 'Erro: Banner group required.');
define('ERROR_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Erro: Target directory does not exist: %s');
define('ERROR_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Erro: Target directory is not writeable: %s');
define('ERROR_IMAGE_DOES_NOT_EXIST', 'Erro: Sem Imagem.');
define('ERROR_IMAGE_IS_NOT_WRITEABLE', 'Erro: Image can not be removed.');
define('ERROR_UNKNOWN_STATUS_FLAG', 'Erro: Unknown status flag.');
define('ERROR_BANNER_IMAGE_REQUIRED', 'Erro: Banner image required.');

define('ERROR_GRAPHS_DIRECTORY_DOES_NOT_EXIST', 'Erro: Graphs directory does not exist. Please create a graphs directory example: <strong>' . DIR_WS_ADMIN . 'images/graphs</strong>');
define('ERROR_GRAPHS_DIRECTORY_NOT_WRITEABLE', 'Erro: Graphs directory is not writeable. This is located at: <strong>' . DIR_WS_ADMIN . 'images/graphs</strong>');

define('TEXT_LEGEND_BANNER_ON_SSL', 'Show SSL');
define('TEXT_LEGEND_BANNER_OPEN_NEW_WINDOWS', 'Novo Window');

// Tooltip Text for images in Banner Manager
define('IMAGE_ICON_BANNER_OPEN_NEW_WINDOWS_ON','Open Novo Window - Enabled');
define('IMAGE_ICON_BANNER_OPEN_NEW_WINDOWS_OFF','Open Novo Window - Disabled');
