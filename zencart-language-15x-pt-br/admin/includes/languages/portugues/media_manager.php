...
define('TEXT_HEADING_NEW_MEDIA_COLLECTION', 'Novo Media Collection');
...
define('TEXT_PRODUCTS', 'Linked Produtos:');
define('TEXT_CLIPS', 'Linked Clips:');
define('TEXT_NO_PRODUCTS', 'No Produtos in this category');
define('TEXT_HEADING_EDIT_MEDIA_COLLECTION', 'Editar Media Collection');
define('TEXT_EDIT_INTRO', 'Please amend the details of the new media collection below');
define('TEXT_HEADING_DELETE_MEDIA_COLLECTION', 'Excluir Media Collection');
define('TEXT_DELETE_INTRO', 'Do you want to delete this media collection?');
 define('TEXT_DISPLAY_NUMBER_OF_MEDIA', 'Mostrando <strong>%d</strong> &agrave; <strong>%d</strong> (de <strong>%d</strong> Media Collections)');
...
define('TEXT_HEADING_ASSIGN_MEDIA_COLLECTION', 'Assign Media Collection to Produto');
define('TEXT_PRODUCTS_INTRO', 'You can assign and remove this Media Collection for products using the forms below.');
define('IMAGE_PRODUCTS', 'Assign to Produto');
define('TEXT_DELETE_PRODUCTS', 'Excluir this Media Collection and all items linked to it?');
define('TEXT_DELETE_WARNING_PRODUCTS', '<strong>ATEN&Ccedil;&Atilde;O:</strong> Ainda existem %s itens linkados a este Media Collection!');
define('TEXT_WARNING_FOLDER_UNWRITABLE', 'NOTA: media folder ' . DIR_FS_CATALOG_MEDIA . ' is not writable. Cannot upload files.');
