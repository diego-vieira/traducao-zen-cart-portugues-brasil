...
define('TEXT_SALEMAKER_PRICERANGE_FROM', 'Produtos Pricerange:');
...
define('TEXT_SALEMAKER_CATEGORIES', '<b>Or</b> check the Categorias to which this sale applies:');
...
define('TEXT_INFO_DATE_MODIFIED', 'Modificado em:');
...
define('SPECIALS_CONDITION_DROPDOWN_0', 'Ignore Specials Price - Apply to Produto Price and Replace Special');
...
define('DEDUCTION_TYPE_DROPDOWN_2', 'Novo Price');
*/
define('TEXT_INFO_HEADING_COPY_SALE', 'Copy Sale');
define('TEXT_INFO_COPY_INTRO', 'Enter a name for the copy of<br />&nbsp;&nbsp;"%s"');
define('TEXT_INFO_HEADING_DELETE_SALE', 'Excluir Sale');
define('TEXT_INFO_DELETE_INTRO', 'Tem certeza que deseja permanently delete this sale?');
define('TEXT_MORE_INFO', '(More Info)');

define('TEXT_WARNING_SALEMAKER_PREVIOUS_CATEGORIES','&nbsp;Aten&ccedil;&atilde;o : %s sales already include this category');
?>