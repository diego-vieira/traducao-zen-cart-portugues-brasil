...
define('TEXT_DELETE_PRODUCT_INTRO', 'Tem certeza que deseja permanently delete this product?<br /><br /><strong>Aten&ccedil;&atilde;o:</strong> On Linked Produtos<br />1 Make sure the Master Categoria has been changed if you are deleting the Produto from the Master Categoria<br />2 Check the checkbox for the Categoria to Delete the Produto from');

define('TEXT_DELETE_WARNING_CHILDS', '<b>ATEN&Ccedil;&Atilde;O:</b> There are %s (child-)Categorias still linked to this category!');
define('TEXT_DELETE_WARNING_PRODUCTS', '<b>ATEN&Ccedil;&Atilde;O:</b> There are %s products still linked to this category!');
...
define('TEXT_PRODUCTS_STATUS', 'Produtos Estado:');
...
define('TEXT_PRODUCTS_MANUFACTURER', 'Produtos Manufacturer:');
define('TEXT_PRODUCTS_NAME', 'Produtos Name:');
define('TEXT_PRODUCTS_DESCRIPTION', 'Produtos Descri&ccedil;&atilde;o:');
define('TEXT_PRODUCTS_QUANTITY', 'Produtos Quantity:');
define('TEXT_PRODUCTS_MODEL', 'Produtos Modelo:');
define('TEXT_PRODUCTS_IMAGE', 'Produtos Image:');
define('TEXT_PRODUCTS_IMAGE_DIR', 'Upload to directory:');
define('TEXT_PRODUCTS_URL', 'Produtos URL:');
define('TEXT_PRODUCTS_URL_WITHOUT_HTTP', '<small>(without http://)</small>');
define('TEXT_PRODUCTS_PRICE_NET', 'Produtos Price (Net):');
define('TEXT_PRODUCTS_PRICE_GROSS', 'Produtos Price (Gross):');
define('TEXT_PRODUCTS_WEIGHT', 'Produtos Shipping Weight:');
...
// Products and Attribute Copy Options
 ...
 define('TEXT_PRODUCTS_QTY_BOX_STATUS_PREVIEW','Aten&ccedil;&atilde;o: Does not show Quantity Box, Default to Qty 1');
 define('TEXT_PRODUCTS_QTY_BOX_STATUS_EDIT','Aten&ccedil;&atilde;o: Does not show Quantity Box, Default to Qty 1');
...
// meta tags
 define('TEXT_META_TAG_TITLE_INCLUDES','<strong>Mark What the Produto\'s Meta Tag Title Should Include:</strong>');
 define('TEXT_PRODUCTS_METATAGS_PRODUCTS_NAME_STATUS','<strong>Produto Name:</strong>');
