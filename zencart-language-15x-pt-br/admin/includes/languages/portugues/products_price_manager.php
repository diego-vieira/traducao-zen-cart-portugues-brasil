...
define('TEXT_SPECIALS_PRODUCT_INFO', 'Pre&ccedil;o Especial Info:');
...
define('TEXT_INFO_MASTER_CATEGORIES_ID_WARNING', '<strong>Aten&ccedil;&atilde;o:</strong> The Produto Master Categoria ID# %s does not match Current Categoria ID# %s and Produto is Not Linked!');
