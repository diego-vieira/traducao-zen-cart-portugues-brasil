...
define('TEXT_MORE_INFORMATION', 'Para maiores informações, visite a <a href="%s" target="_blank">página</a> deste produto.');
...
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Os clientes que compraram este produto também comprarmm...');
