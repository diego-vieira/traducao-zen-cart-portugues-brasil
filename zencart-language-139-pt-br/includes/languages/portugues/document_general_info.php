...
define('TEXT_MORE_INFORMATION', 'Para maiores infomrações, Visite a <a href="%s" target="_blank">página</a> deste produto.');
define('TEXT_DATE_ADDED', 'Este produto foi adicionado ao nosso catálogo em %s.');
define('TEXT_DATE_AVAILABLE', 'Este produto estará em nosso estoque a partir de %s.');
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Os clientes que compraram este produto também compraram...');
...
define('IMAGE_BUTTON_RETURN_TO_PRODUCT_LIST','Voltar à lista de produtos');
