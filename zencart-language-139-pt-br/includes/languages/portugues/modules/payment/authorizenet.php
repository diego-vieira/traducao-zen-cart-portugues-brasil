 ...
 */
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_CATALOG_TITLE', 'Cartão de crédito');  // Payment option title as displayed to the customer
...
if (MODULE_PAYMENT_AUTHORIZENET_STATUS == 'True') {
 ...
 define('MODULE_PAYMENT_AUTHORIZENET_TEXT_DESCRIPTION', '<a target="_blank" href="http://reseller.authorize.net/application.asp?id=131345">Click Here to Sign Up for an Account</a><br /><br /><a target="_blank" href="https://account.authorize.net/">Click to Login to the Authorize.net Merchant Area</a><br /><br /><strong>Requirements:</strong><br /><hr />*<strong>Authorize.net Account</strong> (see link above to signup)<br />*<strong>Authorize.net username and transaction key</strong> available from your Merchant Area');
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_DESCRIPTION', 'Informação de teste do Cartão de crédito:<br /><br />CC#: 4111111111111111<br />Expiração: qualquer');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_TYPE', 'Tipo:');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_OWNER', 'Proprietário do Cartão de Crédito:');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_NUMBER', 'Número do Cartão de Crédito:');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_EXPIRES', 'Data de validade do Cartão de Crédito:');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_CVV', 'CVV Number:');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_POPUP_CVV_LINK', 'What\'s this?');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_OWNER', '* O nome do proprietário do cartão de crédito deve conter no mínimo ' . CC_OWNER_MIN_LENGTH . ' caracteres.\n');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_NUMBER', '* O número do cartão de crédito deve ter no mínimo ' . CC_NUMBER_MIN_LENGTH . ' caracteres.\n');
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_ERROR_MESSAGE', 'Ocorreu um erro no processo do seu cartão de crédito. Por favor tente denovo.');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_DECLINED_MESSAGE', 'Seu cartão de crédito não foi aceito. Por favor tente outro cartão ou entre em contato com sua operadora de Cartão de Crédito ou seu Banco para mais informações.');
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_ERROR', 'Erro no Cartão de Crédito!');
?>