...
define('MODULE_SHIPPING_FREESHIPPER_TEXT_TITLE', 'Frete Grátis!');
define('MODULE_SHIPPING_FREESHIPPER_TEXT_DESCRIPTION', 'Frete Grátis');
define('MODULE_SHIPPING_FREESHIPPER_TEXT_WAY', 'Frete Grátis Somente');
?>
