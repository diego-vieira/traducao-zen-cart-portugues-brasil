...
define('OTHER_BOX_NOTIFY_YES_ALT', 'Me avise sobre atualizações deste produto.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Escrever um comentário sobre este produto.');
define('OTHER_CALL_FOR_PRICE_ALT', 'Chamar pelo preço atual.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Fora do ar para manutenção. Tente novamente dentro de alguns minutos.');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'A APROVAÇÃO DO CLIENTE ESTÁ PENDENTE ...');
