...
define('TEXT_RECORD_COMPANY_URL', 'Para maiores informações, por favor, visite a <a href="%s" target="_blank">página da gravadora</a>.');
define('TEXT_ARTIST_URL', 'Para maiores informações, visite a <a href="%s" target="_blank">página do artista</a>.');
define('TEXT_DATE_ADDED', 'Este produto foi adicionado em nosso catálogo em %s.');
