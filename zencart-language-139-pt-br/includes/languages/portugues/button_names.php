...
define('BUTTON_ADD_ADDRESS_ALT', 'Adicionar endereço');
...
define('BUTTON_CHANGE_ADDRESS_ALT', 'Alterar endereço');
...
define('BUTTON_NEXT_ALT', 'Próximo');
...
define('BUTTON_REVIEWS_ALT', 'Ir para a página de comentários');
...
define('BUTTON_UNSUBSCRIBE', 'Não receber Newsletter');
define('BUTTON_UPDATE_ALT', 'Atualizar');
define('BUTTON_VIEW_SMALL_ALT', 'Ver');
define('BUTTON_WRITE_REVIEW_ALT', 'Escrever comentário');
define('BUTTON_READ_REVIEWS_ALT', 'Ler comentário');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Ir para informações detalhadas deste produto');
define('BUTTON_MORE_REVIEWS_ALT', 'Ver mais comentários');
?>