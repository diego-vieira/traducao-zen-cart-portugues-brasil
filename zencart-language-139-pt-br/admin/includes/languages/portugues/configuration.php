...
define('TABLE_HEADING_CONFIGURATION_TITLE', 'Tнtulo');
define('TABLE_HEADING_CONFIGURATION_VALUE', 'Valor');
define('TABLE_HEADING_ACTION', 'Aзгo');

define('TEXT_INFO_EDIT_INTRO', 'Por favor, faзa os ajutes necessбrios');
define('TEXT_INFO_DATE_ADDED', 'Adicionado em:');
define('TEXT_INFO_LAST_MODIFIED', 'Ъltima Modificaзгo:');
?>