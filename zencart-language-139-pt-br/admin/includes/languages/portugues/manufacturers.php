...
define('TEXT_NEW_INTRO', 'Por favor, preencha as informações do novo fabricante');
...
define('TEXT_DELETE_PRODUCTS', 'Excluir os produtos deste fabricante? (incluindo avaliações de produtos, produtos no cadastro de preços especiais, produtos futuros)');
define('TEXT_DELETE_WARNING_PRODUCTS', '<b>ATENÇÃO:</b> Ainda existe(m) %s produto(s) ligado(s) a este fabricante!');

define('ERROR_DIRECTORY_NOT_WRITEABLE', 'Erro: Não consegui escrever neste diretório. Por favor, configure as permissões corretas para: %s');
