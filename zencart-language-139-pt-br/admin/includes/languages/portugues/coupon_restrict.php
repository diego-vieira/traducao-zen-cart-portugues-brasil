...
define('HEADING_TITLE', 'Restrição de Produto/Categoria em Cupons');
define('HEADING_TITLE_CATEGORY', 'Restrições de Categoria');
define('HEADING_TITLE_PRODUCT', 'Restrições de Produto');
