...
define('HEADING_TITLE_OPT', 'Opções de Produtos');
define('HEADING_TITLE_VAL', 'Valores das Opções');
...
define('TEXT_PRICES_AND_WEIGHTS', 'Preços e Pesos');
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR', 'Fator de Preço: ');
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET', 'Diferença: ');
...
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET_ONETIME', 'Diferença: ');
...
// preview
  ...
  define('TEXT_SPECIAL_PRICE', 'Preço Especial: ');
