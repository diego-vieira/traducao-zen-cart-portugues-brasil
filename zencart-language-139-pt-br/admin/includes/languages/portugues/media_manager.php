...
define('TEXT_DELETE_INTRO', 'Do you want to delete this media collection?');
  define('TEXT_DISPLAY_NUMBER_OF_MEDIA', 'Mostrando <strong>%d</strong> à <strong>%d</strong> (de <strong>%d</strong> Media Collections)');
...
define('TEXT_DELETE_WARNING_PRODUCTS', '<strong>ATENÇÃO:</strong> Ainda existem %s itens linkados a este Media Collection!');
