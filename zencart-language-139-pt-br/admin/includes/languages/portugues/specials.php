...
define('WARNING_SPECIALS_PRE_ADD_EMPTY', 'Atenção: No Produto ID specified ... nada foi adicionado...');
define('WARNING_SPECIALS_PRE_ADD_DUPLICATE', 'Atenção: Produto ID already on Special ... nada foi adicionado...');
define('WARNING_SPECIALS_PRE_ADD_BAD_PRODUCTS_ID', 'Atenção: Produto ID is invalid ... nada foi adicionado...');
