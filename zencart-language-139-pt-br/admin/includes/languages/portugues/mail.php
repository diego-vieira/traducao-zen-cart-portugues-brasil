...
define('NOTICE_EMAIL_FAILED_SEND', 'Notícia: FALHA ao enviar E-mail para os seguintes destinatários: %s');
...
define('ERROR_ATTACHMENTS', 'Erro: Você não pode selecionar tanto ENVIAR e ADICIONAR anexos separadamente. Por favor, escolha apenas um.');
?>