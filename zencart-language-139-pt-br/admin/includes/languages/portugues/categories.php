...
define('TEXT_DELETE_CATEGORY_INTRO_LINKED_PRODUCTS', '<strong>Atenção:</strong> Produtos linkados nas quais as ID das Categorias Mestre são deletadas não terão o preço correto. Você deverá primeiro ter certeza que excluindo uma categoria que possuem produtos linkados, tenham sua Categoria Mestre alterada para outra antes de excluir a categoria');
...
define('ERROR_CANNOT_ADD_PRODUCT_TYPE','O tipo de produto especificado não pode ser adicionado nesta categoria. Por favor, verifique as restrição desta categoria.');
...
// Produtos and Attribute Copy Options
  ...
  define('TEXT_VIRTUAL_PREVIEW','Atenção: Este produto está marcado como - Frete Grátis e Pular Endereço de Entrega');
  define('TEXT_VIRTUAL_EDIT','Atenção: Este produto está marcado como - Frete Grátis e Pular Endreço de Entrega');
  define('TEXT_FREE_SHIPPING_PREVIEW','Atenção: Este produto está marcado como - Frete Grátis, Endereço de Entrega Obrigatório');
  define('TEXT_FREE_SHIPPING_EDIT','Atenção: Sim faça o produto - Frete Grátis, Endereço de Entrega Obrigatório');
  ...
  '<strong>Produtos Virtuais</strong> não são cobrados frete e não requerem um endereço de entrega. Produtos como Serviços, ' . TEXT_GV_NAMES . ', etc.<br />' .
  '<strong>Frete Sempre Grátis</strong> não são cobrados frete, mas requerem um endereço de entrega<br />' .
  '<strong>Downloads</strong> são normalmente Produtos Virtuais - Nenhuma das duas opções precisam ser marcadas<br />'
  );
...
define('TEXT_PRODUCTS_STATUS_NOCHANGE', 'Não Alterar');
define('TEXT_CATEGORIES_STATUS_WARNING', '<strong>ATENÇÃO ...</strong><br />Nota: Desabilitando uma categoria irá desabilitar todos os produtos nesta categoria. Produtos linkados localizados nesta categoria que são compartilhados em outras Categorias também serão desabilitados.');

define('TEXT_PRODUCTS_STATUS_ON_OF',' de ');
define('TEXT_PRODUCTS_STATUS_ACTIVE',' ativo ');

define('TEXT_CATEGORIES_DESCRIPTION', 'Descrição da Categoria:');
define('PRODUCTS_PRICE_IS_CALL_FOR_PRICE_TEXT', 'Produto é Sob Consulta');

// Metatags
  define('TEXT_INFO_HEADING_EDIT_CATEGORY_META_TAGS', 'Definições de Meta Tags da Categoria');
  ...
  define('TEXT_EDIT_CATEGORIES_META_TAGS_DESCRIPTION', 'Descrição:');

define('WARNING_PRODUCTS_IN_TOP_INFO', 'ATENÇÃO: Você possui produtos na Categoria Topo. Isto irá fazer com que os preços não funcionem corretamente. Produtos encontrados: ');
