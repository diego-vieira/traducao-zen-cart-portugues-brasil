...
define('TEXT_SINGLE_EMAIL', '<span class="smallText">Use isto para enviar um único e-mail, ou use a lista acima</span>');
...
define('ERROR_GV_AMOUNT', 'Por favor, defina o valor como um valor sem símbolos. Example: 25.00');

define('TEXT_GV_ANNOUNCE','<font color="#0000ff">Nós gostaríamos de lhe oferecer este ' . TEXT_GV_NAME . '</font>');
...
define('TEXT_WHICH_IS', ' que é');
define('TEXT_IN_CASE', ' se você tiver algum problema.');
define('TEXT_OR_VISIT', 'ou visite ');
define('TEXT_ENTER_CODE', ' e digite o código durante o processo de pagamento');
define('TEXT_CLICK_TO_REDEEM','Clique aqui para resgatar');

define ('TEXT_REDEEM_COUPON_MESSAGE_HEADER', 'Você comprou recentemente um ' . TEXT_GV_NAME . ' de nosso site, por questões de segurança, a quantia do ' . TEXT_GV_NAME . ' não foi imediatamente creditado pra você. O dono da loja liberou agora este valor.');
define ('TEXT_REDEEM_COUPON_MESSAGE_AMOUNT', "\n\n" . 'O valor do ' . TEXT_GV_NAME . ' é %s');
define ('TEXT_REDEEM_COUPON_MESSAGE_BODY', "\n\n" . 'Você pode agora visitar nosso site, entrar com sua conta e enviar o valor do ' . TEXT_GV_NAME . ' para qualquer pessoa.');
