...
//
  ...
  define('HEADING_WARNING_INSTALLSCRIPTS', 'NOTA: Zen Cart database-upgrade scripts should NOT be run from this page.<br />Please upload the new <strong>zc_install</strong> folder and run the upgrade from there instead for better reliability.');
  ...
  define('ERROR_NOTHING_TO_DO','Erro: Nothing to do - no query or query-file specified.');
...
<br /><strong>NOTA: </strong>SELECT.... FROM... and LEFT JOIN statements need the "FROM" or "LEFT JOIN" to be on a line by itself in order for the parse script to add the table prefix.<br /><br />
...
LIGADO p.othercol_f = po.othercol_f<br />
