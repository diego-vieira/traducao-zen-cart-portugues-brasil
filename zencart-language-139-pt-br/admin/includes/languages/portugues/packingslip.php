...
define('ENTRY_SHIP_TO', 'ENVIAR PARA:');
define('ENTRY_PAYMENT_METHOD', 'Forma de Forma de Pagamento:');
define('ENTRY_DATE_PURCHASED', 'Data da Venda:');

define('ENTRY_ORDER_ID','No. do Recibo ');
?>